    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                <div class="text-2xl font-bold text-indigo-400 mb-4">BlogNest</div>
                <p class="text-gray-400 mb-4 max-w-md">A platform for writers to share their stories, connect with readers, and build their online presence.</p>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
            <p>&copy; {{ date('Y') }} BlogNest. All rights reserved.</p>
        </div>
    </div>
</footer>
